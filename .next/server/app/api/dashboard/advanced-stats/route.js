"use strict";(()=>{var e={};e.id=1185,e.ids=[1185],e.modules={3295:e=>{e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},10846:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},19771:e=>{e.exports=require("process")},27910:e=>{e.exports=require("stream")},28354:e=>{e.exports=require("util")},29294:e=>{e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},34631:e=>{e.exports=require("tls")},41204:e=>{e.exports=require("string_decoder")},44870:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},55511:e=>{e.exports=require("crypto")},63033:e=>{e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},66136:e=>{e.exports=require("timers")},70307:(e,r,t)=>{t.r(r),t.d(r,{patchFetch:()=>N,routeModule:()=>p,serverHooks:()=>T,workAsyncStorage:()=>d,workUnitAsyncStorage:()=>A});var s={};t.r(s),t.d(s,{GET:()=>E});var a=t(96559),o=t(48088),i=t(37719),n=t(32190),u=t(4160),c=t(12909);async function E(e){try{let r=e.headers.get("authorization");if(!r||!r.startsWith("Bearer "))return n.NextResponse.json({message:"לא מורשה"},{status:401});let t=r.split(" ")[1];if(!(0,c.bw)(t))return n.NextResponse.json({message:"טוקן לא תקף"},{status:401});let s=`
      SELECT 
