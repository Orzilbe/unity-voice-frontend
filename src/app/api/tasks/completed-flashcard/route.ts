...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const backendUrl = process.env.NEXT_PUBLIC_API_URL || process.env.API_URL || 'https://unity-voice-api-linux-f2hsapgsh3hcgqc0.israelcentral-01.azurewebsites.net/api';
    ...
    if (error instanceof Error && error.message.includes('fetch')) {
      return NextResponse.json({
        ...
        backendUrl: process.env.NEXT_PUBLIC_API_URL || process.env.API_URL || 'https://unity-voice-api-linux-f2hsapgsh3hcgqc0.israelcentral-01.azurewebsites.net/api'
      }, { status: 503 });
    }
